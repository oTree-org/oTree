...
SECRET_KEY = '{{ ujhiubhgg789798ygjh }}'

DEMO_PAGE_INTRO_HTML = """
Here are Some Game Theory Games.
"""
...
SESSION_CONFIGS = [
    ...
    dict(name='common_value_auction',
...
ROOMS = [
    dict(
        name='econ371',
        display_name='Econ econ371 class',
